            ...
            <div class="page-shell">
                <div class="p-6">
                    ...
                    @if(isset($isEditing) && $isEditing)
                        <form action="{{ route('employees.update', $employee->id) }}" method="POST" class="surface-muted space-y-6" id="employeeForm">
                        @method('PUT')
                    @else
                        <form action="{{ route('employees.store') }}" method="POST" class="surface-muted space-y-6" id="employeeForm">
                    @endif
                        @csrf
