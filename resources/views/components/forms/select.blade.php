<div>
    ...
    <div class="flex justify-center items-center gap-x-3 mt-1 rounded-md bg-white border border-background pr-4 focus-within:border-primary">
        <div class="relative w-full">
            <select {{$attributes->merge(['class' => "h-[45px] text-neutral text-sm bg-transparent border-0 rounded-none w-full focus-visible:ring-0 focus-visible:ring-offset-0 px-4 focus-visible:outline-hidden appearance-none webkit-appearance-none !bg-none"])}}>
                {{$slot}}
            </select>
