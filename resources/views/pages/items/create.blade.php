    ...
    <div class="py-12">
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="page-shell">
                <div class="p-6">
                    <div class="mb-6">
                        <a href="{{ route('items.index') }}" class="btn-secondary mb-4 inline-flex items-center">
                    ...
                    @if(isset($isEditing) && $isEditing)
                        <form action="{{ route('items.update', $item->id) }}" method="POST" class="surface-muted space-y-6" id="itemForm">
                        @method('PUT')
                    @else
                        <form action="{{ route('items.store') }}" method="POST" class="surface-muted space-y-6" id="itemForm">
                    @endif
                        @csrf
